...
export function ImpactSummary({ bondId }: { bondId: number }) {
    ...
    const typedImpact = impact as ImpactData;
    const carbon = typedImpact.carbonReduced;
    const jobs = typedImpact.jobsCreated;
    const sme = typedImpact.smeSupported;
    const reportUrl = typedImpact.reportUrl || "";
